...
Use ctrl+_ to “Jump To Line” and enter 135.  The two lines you have to comment out are in the screenshot, below:

	php artisan serve (Note: I had to run this twice for it to take)
